...
void loop() {
  ...
  if(mode==0){
    ...
    tone(8,440+5*m0i,delay1);
    // inward are purple
    strip.setPixelColor(0,m0i,0,m0i);
    strip.setPixelColor(16,m0i,0,m0i);
    strip.setPixelColor(17,m0i,0,m0i);
    strip.setPixelColor(33,m0i,0,m0i);
    strip.setPixelColor(34,m0i,0,m0i);
    strip.setPixelColor(50,m0i,0,m0i);
    // poles are green and blue
    strip.setPixelColor(51,0,m0i,0);
    strip.setPixelColor(52,0,0,m0i);    
  }
  
  // mode 1 is just the 2 last leds
  // for testing make them controlled from octave
  if(mode==1){
    delay1=2;
    strip.setPixelColor(51,xred,xgreen,xblue);
    strip.setPixelColor(52,xred,xgreen,xblue);
  }
  ...
  delay(delay1);                        // Variable delay controls apparent speed
